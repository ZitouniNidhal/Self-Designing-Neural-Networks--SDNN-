...
@cli.command()
@click.option(
    "--task", default=CLIArgs.task, help="Discovery task (e.g. image_classification, nlp)"
)
@click.option(
    "--iterations", default=CLIArgs.iterations, type=int, help="Number of discovery iterations"
)
